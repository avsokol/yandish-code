...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(os.path.join(os.path.dirname(os.path.realpath(__file__)), "../ico/tab_opts.png"))), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(os.path.join(os.path.dirname(os.path.realpath(__file__)), "../ico/start.png"))), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnStart.setIcon(icon3)
        self.btnStart.setObjectName(_fromUtf8("btnStart"))
        self.hboxlayout.addWidget(self.btnStart)
        self.btnStop = QtGui.QPushButton(self.ctrFrame)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(os.path.join(os.path.dirname(os.path.realpath(__file__)), "../ico/stop.png"))), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(os.path.join(os.path.dirname(os.path.realpath(__file__)), "../ico/status.png"))), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnStatus.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(os.path.join(os.path.dirname(os.path.realpath(__file__)), "../ico/exit.png"))), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionStatus.setIcon(icon5)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(os.path.join(os.path.dirname(os.path.realpath(__file__)), "../ico/save.png"))), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSaveCfg.setIcon(icon7)
        self.actionSaveCfg.setObjectName(_fromUtf8("actionSaveCfg"))
        self.actionReloadCfg = QtGui.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(os.path.join(os.path.dirname(os.path.realpath(__file__)), "../ico/reload.png"))), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionReloadCfg.setIcon(icon8)
